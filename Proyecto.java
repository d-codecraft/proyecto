...
public class Proyecto extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (isValid(username, password)) {
            ...
            while (Ejercicios){
                String[] opciones = {"Números Primos", "Factorial", "Calculadora", "Contar Vocales", "Tabla de Multiplicar", "Ordenar Números"};
                ...
                if (seleccion == 0) {
                 ...
                 // Mostrar un cuadro de diálogo preguntando si el usuario desea continuar o salir del programa
                int respuesta = JOptionPane.showConfirmDialog(this, "¿Desea realizar otro ejercicio?", "Continuar", JOptionPane.YES_NO_OPTION);
        ...
        // Definir una variable para controlar si el programa debe seguir ejecutándose
                

        //Despedida al finalizar el programa
        JOptionPane.showMessageDialog(this, "¡Gracias por utilizar el programa!", "Adiós", JOptionPane.INFORMATION_MESSAGE);
        System.exit(0);
